 ...
 * 2. Extracts the username from the source_url
 ...
 *   - SUPABASE_SERVICE_ROLE_KEY or SUPABASE_SERVICE_KEY in .env
 */
...
try {
  ...
  // dotenv not installed, that's okay - use env vars directly
}
 ...
 */
function extractSourceUserFromUrl(url) {
